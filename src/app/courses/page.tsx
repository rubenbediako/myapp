...
import { GraduationCap, ArrowRight, BookOpen, Mic, Play, Users, Clock, Award, Target, Trophy, Brain } from 'lucide-react';
...
export default function CoursesPage() {
    ...
    return (
        <div className="container mx-auto px-4 py-6 space-y-6">
            ...
            {/* Interactive Learning Features Highlight */}
            <Card className="bg-gradient-to-r from-primary/5 to-secondary/5 border-primary/20">
                <CardHeader>
                    ...
                    <CardDescription className="text-center text-base">
                        Complete your learning journey with quizzes, badges, and shareable certificates
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <div className="grid md:grid-cols-3 gap-6">
                        <div className="text-center space-y-2">
                            ...
                            <h3 className="font-semibold">Section Quizzes</h3>
                            <p className="text-sm text-muted-foreground">
                                Test your knowledge with 10 multiple-choice questions per section. 70% required to pass.
                            </p>
                        </div>
                        <div className="text-center space-y-2">
                            ...
                            <p className="text-sm text-muted-foreground">
                                Earn badges for completing lessons and passing quizzes. Track your learning progress.
                            </p>
                        </div>
                        <div className="text-center space-y-2">
                            ...
                            <h3 className="font-semibold">Course Certificates</h3>
                            <p className="text-sm text-muted-foreground">
                                Download and share your PDF course completion certificate with your score.
                            </p>
                        </div>
                    </div>
                </CardContent>
